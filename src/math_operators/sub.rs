...
/// Performs element-wise subtraction of two price arrays
pub fn sub(array1: &[Price], array2: &[Price]) -> TAResult<Vec<Price>> {
...
pub fn sub_scalar(array: &[Price], scalar: Price) -> TAResult<Vec<Price>> {
